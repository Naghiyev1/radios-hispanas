...
- Includes dark mode with local preference saving
- Includes an improved bottom player with station logo, country/stream info, favourite button and stop button
